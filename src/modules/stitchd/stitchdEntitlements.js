...
const ENTITLEMENTS = {
  starter: {
    aiCaps:          { transcription: 30, fit_consultant: 20, brief: 20, design: 5, validator: 50, autotag: 20, social: 5 },
    teamMemberSlots: 1,
    features:        { teamMembers: false, designGenerator: true, briefExtractor: true, socialPost: false },
  },
  pro: {
    aiCaps:          { transcription: 500, fit_consultant: 300, brief: 200, design: 100, validator: 1000, autotag: 500, social: 100 },
    teamMemberSlots: 5,
    features:        { teamMembers: true, designGenerator: true, briefExtractor: true, socialPost: true },
  },
  enterprise: {
    aiCaps:          { transcription: Infinity, fit_consultant: Infinity, brief: Infinity, design: Infinity, validator: Infinity, autotag: Infinity, social: Infinity },
