...
const sql = fs.readFileSync(
  path.join(__dirname, '024_orders_shipped_status.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 024_orders_shipped_status …');
    await client.query(sql);
    console.log('✅  Migration complete — shipped_at column added, status constraint updated.');
  } catch (err) {
