...
const sql = fs.readFileSync(
  path.join(__dirname, '033_suggested_styles.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 033_suggested_styles …');
    await client.query(sql);
    console.log('✅  Migration complete — suggested_styles table created.');
  } catch (err) {
