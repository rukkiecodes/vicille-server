...
const sql = fs.readFileSync(
  path.join(__dirname, '030_user_referral_code.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 030_user_referral_code …');
    await client.query(sql);
    console.log('✅  Migration complete — referral_code column added to users table.');
  } catch (err) {
