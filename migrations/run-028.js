...
const sql = fs.readFileSync(
  path.join(__dirname, '028_affiliates.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 028_affiliates …');
    await client.query(sql);
    console.log('✅  Migration complete — affiliates, affiliate_wallets, affiliate_wallet_transactions tables created.');
  } catch (err) {
