...
const sql = fs.readFileSync(
  path.join(__dirname, '025_user_saved_tailors.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 025_user_saved_tailors ...');
    await client.query(sql);
    console.log('✅  Migration complete — user_saved_tailors table ready.');
  } catch (err) {
