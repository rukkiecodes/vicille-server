...
const sql = fs.readFileSync(
  path.join(__dirname, '042_stitchd_payments.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 042_stitchd_payments …');
    await client.query(sql);
    console.log('✅  Migration complete — 042_stitchd_payments stub applied (no-op; table body lands in batch 01).');
  } catch (err) {
