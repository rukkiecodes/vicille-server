/**
 * Adds paystack_customer_code column to the users table.
 *
...
const sql = fs.readFileSync(
  path.join(__dirname, '006_users_paystack_customer.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 006_users_paystack_customer …');
    await client.query(sql);
    console.log('✅  Migration complete — paystack_customer_code column added to users.');
  } catch (err) {
