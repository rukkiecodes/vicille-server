...
const sql = fs.readFileSync(
  path.join(__dirname, '044_stitchd_rls.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 044_stitchd_rls …');
    await client.query(sql);
    console.log('✅  Migration complete — 044_stitchd_rls stub applied (no-op; RLS policies land in batch 01).');
  } catch (err) {
