...
const sql = fs.readFileSync(
  path.join(__dirname, '043_stitchd_threads.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 043_stitchd_threads …');
    await client.query(sql);
    console.log('✅  Migration complete — 043_stitchd_threads stub applied (no-op; table bodies land in batch 01).');
  } catch (err) {
