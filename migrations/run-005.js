/**
 * Adds the missing billing columns to user_subscriptions.
 *
...
const sql = fs.readFileSync(
  path.join(__dirname, '005_user_subscriptions_billing.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 005_user_subscriptions_billing …');
    await client.query(sql);
    console.log('✅  Migration complete — billing and next_billing_date columns added.');
  } catch (err) {
