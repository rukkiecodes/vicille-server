...
const sql = fs.readFileSync(
  path.join(__dirname, '027_plan_referral_reward.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 027_plan_referral_reward …');
    await client.query(sql);
    console.log('✅  Migration complete — referral_reward_ngn column added to subscription_plans.');
  } catch (err) {
