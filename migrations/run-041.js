...
const sql = fs.readFileSync(
  path.join(__dirname, '041_stitchd_orders.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 041_stitchd_orders …');
    await client.query(sql);
    console.log('✅  Migration complete — 041_stitchd_orders stub applied (no-op; table bodies land in batch 01).');
  } catch (err) {
