...
const sql = fs.readFileSync(
  path.join(__dirname, '026_referral_settings.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    console.log('Running migration 026_referral_settings …');
    await client.query(sql);
    console.log('✅  Migration complete — referral_settings table created, seeded with ₦1,000 base amount.');
  } catch (err) {
